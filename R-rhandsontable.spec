...
Version  : 0.3.8
Release  : 41
URL      : https://cran.r-project.org/src/contrib/rhandsontable_0.3.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rhandsontable_0.3.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641096112
